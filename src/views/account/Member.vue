        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-if="column.dataIndex === 'lastLoginIp'">
            ...
            >
              ...
              <a class="link-text" @click="handleQueryIp(record)">{{ record.lastLoginIp }}</a>
            </a-popover>
          </template>
          <!-- 状态开关带文字 -->
...
// 查询IP地址归属地
const handleQueryIp = async (record) => {
  // 关闭其他行的popover
  ...
  try {
    ...
    const response = await fetch(`http://ip-api.com/json/${record.lastLoginIp}?lang=zh-CN`)
...
const tableData = ref([
  ...
  },
  {
    ...
    profit: 350.0,
    inviteCode2: 'UV12',
    withdrawInfo: '0xAABBCCDD1234567890AABBCCDD1234567890AABB',
    lastLoginIp: '192.168.2.100',
    lastLoginDevice: 'Chrome v 122.0.0.0(Windows v 11.0)',
    lastLoginTime: '2025-12-10 11:30:00',
    registerTime: '2025-05-10 09:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    remark: '',
    parentUid: '11111111',
    parentEmail: 'member11@example.com',
    parentPhone: '1-1111111111',
    parentUsername: 'MemberAlpha',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 90,
    ...
    lastLoginDevice: 'Safari v 17.2(IOS v 17.2)',
    lastLoginTime: '2025-12-09 16:45:00',
    registerTime: '2025-10-20 14:30:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 980.0,
    inviteCode2: 'YZ56',
    withdrawInfo: '0x1122334455667788990011223344556677889900',
    lastLoginIp: '172.16.1.200',
    lastLoginDevice: 'Edge v 121.0.0.0(Windows v 11.0)',
    lastLoginTime: '2025-12-10 08:15:00',
    registerTime: '2025-02-15 10:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    remark: '',
    parentUid: '33333333',
    parentEmail: 'member13@example.com',
    parentPhone: '1-3333333333',
    parentUsername: 'MemberGamma',
    directCount: 2,
    totalCount: 5,
    verified: true,
    creditScore: 115,
    ...
    inviteCode2: 'AB78',
    withdrawInfo: '',
    lastLoginIp: '198.51.100.75',
    lastLoginDevice: 'Chrome v 121.0.0.0(MacOS v 14.2)',
    lastLoginTime: '2025-12-09 20:00:00',
    registerTime: '2025-06-25 15:30:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    phone: '1-5555555555',
    username: 'MemberEpsilon',
    vipLevel: 'Junior-level employee(1)',
    vipRecharge: 100,
    remark: '新用户',
    parentUid: '44444444',
    parentEmail: '-',
    parentPhone: '1-4444444444',
    parentUsername: 'MemberDelta',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 100,
    ...
    inviteCode2: 'CD90',
    withdrawInfo: '',
    lastLoginIp: '100.64.1.100',
    lastLoginDevice: 'Firefox v 121.0(Android v 14)',
    lastLoginTime: '2025-12-08 18:30:00',
    registerTime: '2025-11-28 12:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 750.0,
    inviteCode2: 'EF12',
    withdrawInfo: '0xDDEEFF0011223344556677889900AABBCCDDEEFF',
    lastLoginIp: '203.0.113.100',
    lastLoginDevice: 'Chrome v 122.0.0.0(Windows v 10.0)',
    lastLoginTime: '2025-12-10 09:00:00',
    registerTime: '2025-03-20 11:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    remark: '优质客户',
    parentUid: '66666666',
    parentEmail: 'member16@example.com',
    parentPhone: '1-6666666666',
    parentUsername: 'MemberZeta',
    directCount: 1,
    totalCount: 2,
    verified: true,
    creditScore: 120,
    ...
    inviteCode2: 'GH34',
    withdrawInfo: '',
    lastLoginIp: '192.0.2.50',
    lastLoginDevice: 'Safari v 17.0(MacOS v 14.0)',
    lastLoginTime: '2025-12-09 14:00:00',
    registerTime: '2025-07-10 08:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    phone: '1-8888888888',
    username: 'MemberTheta',
    vipLevel: 'Junior-level employee(1)',
    vipRecharge: 100,
    remark: '',
    parentUid: '77777777',
    parentEmail: '-',
    parentPhone: '1-7777777777',
    parentUsername: 'MemberEta',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 85,
    ...
    lastLoginDevice: 'Chrome v 120.0.0.0(Android v 13)',
    lastLoginTime: '2025-12-07 22:00:00',
    registerTime: '2025-12-01 16:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: false,
    commentStatus: true
  },
  {
    ...
    profit: 65.0,
    inviteCode2: 'KL78',
    withdrawInfo: '0xABCDEF123456789012345678901234567890ABCD',
    lastLoginIp: '172.16.2.50',
    lastLoginDevice: 'Edge v 120.0.0.0(Windows v 11.0)',
    lastLoginTime: '2025-12-08 10:30:00',
    registerTime: '2025-08-15 13:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 1500.0,
    inviteCode2: 'MN90',
    withdrawInfo: '0x9876ABCD5432EFGH1098IJKL7654MNOP3210QRST',
    lastLoginIp: '198.51.100.200',
    lastLoginDevice: 'Chrome v 122.0.0.0(MacOS v 14.2)',
    lastLoginTime: '2025-12-10 10:45:00',
    registerTime: '2025-01-10 09:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    email: '-',
    phone: '1-2020202020',
    username: 'MemberLambda',
    vipLevel: 'Mid-level employees(2)',
    vipRecharge: 500,
    remark: '',
    parentUid: '10101010',
    parentEmail: 'member20@example.com',
    parentPhone: '1-1010101010',
    parentUsername: 'MemberKappa',
    directCount: 2,
    totalCount: 4,
    verified: true,
    creditScore: 130,
    ...
    inviteCode2: 'OP12',
    withdrawInfo: '',
    lastLoginIp: '100.64.2.100',
    lastLoginDevice: 'Firefox v 122.0(Windows v 11.0)',
    lastLoginTime: '2025-12-09 18:15:00',
    registerTime: '2025-04-20 14:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    parentUid: '20202020',
    parentEmail: '-',
    parentPhone: '1-2020202020',
    parentUsername: 'MemberLambda',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 75,
    ...
    inviteCode2: 'QR34',
    withdrawInfo: '',
    lastLoginIp: '192.168.3.50',
    lastLoginDevice: 'Safari v 16.5(IOS v 16.5)',
    lastLoginTime: '2025-12-06 12:00:00',
    registerTime: '2025-12-03 10:00:00',
    accountStatus: false,
    tradeStatus: false,
    withdrawStatus: false,
    commentStatus: true
  },
  {
    ...
    profit: 120.0,
    inviteCode2: 'ST56',
    withdrawInfo: '0xFEDCBA0987654321FEDCBA0987654321FEDCBA09',
    lastLoginIp: '203.0.113.150',
    lastLoginDevice: 'Chrome v 121.0.0.0(Linux)',
    lastLoginTime: '2025-12-08 16:30:00',
    registerTime: '2025-06-05 11:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 850.0,
    inviteCode2: 'UV78',
    withdrawInfo: '0x1234ABCD5678EFGH9012IJKL3456MNOP7890QRST',
    lastLoginIp: '10.0.3.200',
    lastLoginDevice: 'Edge v 122.0.0.0(Windows v 11.0)',
    lastLoginTime: '2025-12-10 07:30:00',
    registerTime: '2025-02-28 08:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    email: '-',
    phone: '1-6060606060',
    username: 'MemberOmicron',
    vipLevel: 'Mid-level employees(2)',
    vipRecharge: 500,
    remark: '',
    parentUid: '50505050',
    parentEmail: 'member24@example.com',
    parentPhone: '1-5050505050',
    parentUsername: 'MemberXi',
    directCount: 2,
    totalCount: 3,
    verified: true,
    creditScore: 125,
    ...
    inviteCode2: 'WX90',
    withdrawInfo: '',
    lastLoginIp: '172.16.3.100',
    lastLoginDevice: 'Safari v 17.1(MacOS v 14.1)',
    lastLoginTime: '2025-12-09 11:00:00',
    registerTime: '2025-05-15 16:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    parentUid: '60606060',
    parentEmail: '-',
    parentPhone: '1-6060606060',
    parentUsername: 'MemberOmicron',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 95,
    ...
    inviteCode2: 'YZ12',
    withdrawInfo: '',
    lastLoginIp: '192.0.2.150',
    lastLoginDevice: 'Chrome v 120.0.0.0(Android v 14)',
    lastLoginTime: '2025-12-07 19:00:00',
    registerTime: '2025-11-25 09:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 89.0,
    inviteCode2: 'AB34',
    withdrawInfo: '0xABCDEF9876543210ABCDEF9876543210ABCDEF98',
    lastLoginIp: '100.64.3.50',
    lastLoginDevice: 'Firefox v 120.0(Windows v 10.0)',
    lastLoginTime: '2025-12-08 14:00:00',
    registerTime: '2025-07-20 12:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 680.0,
    inviteCode2: 'CD56',
    withdrawInfo: '0x5678MNOP9012QRST3456UVWX7890YZAB1234CDEF',
    lastLoginIp: '198.51.100.100',
    lastLoginDevice: 'Chrome v 122.0.0.0(Windows v 11.0)',
    lastLoginTime: '2025-12-10 08:45:00',
    registerTime: '2025-03-05 10:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    remark: '',
    parentUid: '90909090',
    parentEmail: 'member28@example.com',
    parentPhone: '1-9090909090',
    parentUsername: 'MemberSigma',
    directCount: 2,
    totalCount: 5,
    verified: true,
    creditScore: 135,
    ...
    inviteCode2: 'EF78',
    withdrawInfo: '',
    lastLoginIp: '172.16.4.50',
    lastLoginDevice: 'Safari v 17.2(IOS v 17.2)',
    lastLoginTime: '2025-12-09 15:30:00',
    registerTime: '2025-04-10 13:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    phone: '1-1313131313',
    username: 'MemberUpsilon',
    vipLevel: 'Junior-level employee(1)',
    vipRecharge: 100,
    remark: '新注册',
    parentUid: '12121212',
    parentEmail: '-',
    parentPhone: '1-1212121212',
    parentUsername: 'MemberTau',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 100,
    ...
    inviteCode2: 'GH90',
    withdrawInfo: '',
    lastLoginIp: '203.0.113.75',
    lastLoginDevice: 'Chrome v 121.0.0.0(Android v 13)',
    lastLoginTime: '2025-12-06 16:00:00',
    registerTime: '2025-12-04 11:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 78.0,
    inviteCode2: 'IJ12',
    withdrawInfo: '0xQRST7890UVWX1234YZAB5678CDEF9012GHIJ3456',
    lastLoginIp: '10.0.4.100',
    lastLoginDevice: 'Edge v 121.0.0.0(Windows v 10.0)',
    lastLoginTime: '2025-12-08 20:00:00',
    registerTime: '2025-08-25 09:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 1120.0,
    inviteCode2: 'KL34',
    withdrawInfo: '0xMNOP3456QRST7890UVWX1234YZAB5678CDEF9012',
    lastLoginIp: '192.168.4.200',
    lastLoginDevice: 'Chrome v 122.0.0.0(MacOS v 14.2)',
    lastLoginTime: '2025-12-10 11:00:00',
    registerTime: '2025-01-25 08:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    remark: '',
    parentUid: '15151515',
    parentEmail: 'member32@example.com',
    parentPhone: '1-1515151515',
    parentUsername: 'MemberChi',
    directCount: 2,
    totalCount: 4,
    verified: true,
    creditScore: 125,
    ...
    inviteCode2: 'MN56',
    withdrawInfo: '',
    lastLoginIp: '100.64.4.150',
    lastLoginDevice: 'Firefox v 121.0(Windows v 11.0)',
    lastLoginTime: '2025-12-09 13:00:00',
    registerTime: '2025-05-08 14:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    phone: '1-1717171717',
    username: 'MemberOmega',
    vipLevel: 'Junior-level employee(1)',
    vipRecharge: 100,
    remark: '',
    parentUid: '16161616',
    parentEmail: '-',
    parentPhone: '1-1616161616',
    parentUsername: 'MemberPsi',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 90,
    ...
    inviteCode2: 'OP78',
    withdrawInfo: '',
    lastLoginIp: '172.16.5.50',
    lastLoginDevice: 'Safari v 16.5(IOS v 16.5)',
    lastLoginTime: '2025-12-07 15:00:00',
  ...
  },
  {
    ...
    profit: 135.0,
    inviteCode2: 'QR90',
    withdrawInfo: '0xGHIJ3456KLMN7890OPQR1234STUV5678WXYZ9012',
    lastLoginIp: '198.51.100.50',
    lastLoginDevice: 'Chrome v 121.0.0.0(Linux)',
    lastLoginTime: '2025-12-08 12:00:00',
    registerTime: '2025-06-15 11:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 950.0,
    inviteCode2: 'ST12',
    withdrawInfo: '0xKLMN7890OPQR1234STUV5678WXYZ9012ABCD3456',
    lastLoginIp: '203.0.113.200',
    lastLoginDevice: 'Edge v 122.0.0.0(Windows v 11.0)',
    lastLoginTime: '2025-12-10 09:30:00',
    registerTime: '2025-02-10 09:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    email: '-',
    phone: '1-2121212121',
    username: 'UserGamma03',
    vipLevel: 'Mid-level employees(2)',
    vipRecharge: 500,
    remark: '',
    parentUid: '19191919',
    parentEmail: 'member36@example.com',
    parentPhone: '1-1919191919',
    parentUsername: 'UserBeta02',
    directCount: 2,
    totalCount: 3,
    verified: true,
    creditScore: 120,
    ...
    inviteCode2: 'UV34',
    withdrawInfo: '',
    lastLoginIp: '10.0.5.100',
    lastLoginDevice: 'Safari v 17.0(MacOS v 14.0)',
    lastLoginTime: '2025-12-09 17:00:00',
    registerTime: '2025-04-25 15:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    phone: '1-2323232323',
    username: 'UserDelta04',
    vipLevel: 'Junior-level employee(1)',
    vipRecharge: 100,
    remark: '待审核',
    parentUid: '21212121',
    parentEmail: '-',
    parentPhone: '1-2121212121',
    parentUsername: 'UserGamma03',
    directCount: 0,
    totalCount: 0,
    verified: false,
    creditScore: 85,
    ...
    lastLoginDevice: 'Chrome v 120.0.0.0(Android v 14)',
    lastLoginTime: '2025-12-06 14:00:00',
    registerTime: '2025-12-02 08:00:00',
    accountStatus: true,
    tradeStatus: false,
    withdrawStatus: false,
    commentStatus: true
  },
  {
    ...
    profit: 72.0,
    inviteCode2: 'YZ78',
    withdrawInfo: '0xOPQR1234STUV5678WXYZ9012ABCD3456EFGH7890',
    lastLoginIp: '100.64.5.200',
    lastLoginDevice: 'Firefox v 120.0(Windows v 10.0)',
    lastLoginTime: '2025-12-08 18:00:00',
    registerTime: '2025-08-10 13:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
  },
  {
    ...
    profit: 1850.0,
    inviteCode2: 'AB90',
    withdrawInfo: '0xSTUV5678WXYZ9012ABCD3456EFGH7890IJKL1234',
    lastLoginIp: '172.16.6.100',
    lastLoginDevice: 'Chrome v 122.0.0.0(Windows v 11.0)',
    lastLoginTime: '2025-12-10 10:00:00',
    registerTime: '2025-01-05 08:00:00',
    accountStatus: true,
    tradeStatus: true,
    withdrawStatus: true,
    commentStatus: true
